	...
	function D(n, t) {
		...
		switch (k.type) {
			...
			case "calendar":
				...
				a += "<div class=\"widget\" id=\"lich-am-duong\"><div class=\"d-flex justify-content-between align-items-center\">\r\n<div id=\"previous-date-right\" data-day=\"19\" data-month=\"3\" data-year=\"2024\" class=\"p-2 cursor-pointer h-100 d-flex align-items-center justify-content-center hover-dark\">\r\n\r\n<\/div>\r\n<div class=\"text-center d-flex justify-content-center align-items-center\">\r\n<div><p id=\"txt-today\" class=\"txt-sub-content mb-1\">H\u00f4m nay\r\n<\/p><p id=\"lvn-full-right\" class=\"txt-content-bold mb-0\">" + E[(an.jd + 1) % 7] + ", " + tn.getDate() + "\/" + (tn.getMonth() + 1) + "\/" + tn.getFullYear() + "\r\n<\/p>\r\n<\/div>\r\n<\/div>\r\n<div id=\"next-date-right\" data-day=\"19\" data-month=\"3\" data-year=\"2024\" class=\"p-2 cursor-pointer h-100 d-flex align-items-center justify-content-center hover-dark\">\r\n\r\n<\/div>\r\n<\/div>\r\n<div class=\"widget-calendar\">\r\n<img class=\"widget-calendar-circle\" alt=\"calender circle\" src=\"\/wp-content\/plugins\/lunar_widget\/assets\/css\/images\/widget_calendar_circle.png\">\r\n<img class=\"left-widget-calendar-corner\" alt=\"widget corner\" src=\"\/wp-content\/plugins\/lunar_widget\/assets\/css\/images\/widget_calendar_corner.png\">\r\n<img class=\"right-widget-calendar-corner\" alt=\"widget corner\" src=\"\/wp-content\/plugins\/lunar_widget\/assets\/css\/images\/widget_calendar_corner.png\">\r\n<p id=\"lvn-l-month-right\" class=\"txt-content-bold widget-calendar-month mb-0\">Tháng " + R[an.month - 1] + "\r\n<\/p>\r\n<p id=\"lvn-l-day-right\" class=\"widget-calendar-date txt-title-bold mb-0\">" + an.day + "<\/p>\r\n<p class=\"txt-sub-content widget-calendar-text\">\r\nNg\u00e0y:\r\n<span class=\"txt-sub-content-bold\" id=\"lvn-ch-day-right\">" + e[0] + "<\/span>\r\n, th\u00e1ng:\r\n<span class=\"txt-sub-content-bold\" id=\"lvn-ch-month-right\">" + e[1] + "<\/span>\r\n<\/p>\r\n<\/div>\r\n<div class=\"p-t-10 p-l-10 p-r-10 p-b-15\">\r\n<p class=\"txt-content-bold m-b-5\">Gi\u1edd Ho\u00e0ng \u0110\u1ea1o (Gi\u1edd t\u1ed1t):<\/p>\r\n<p class=\"txt-sub-content m-b-15\" id=\"lvn-ngay-tot-right\">" + f(an.jd) + "<\/p>\r\n<div class=\"d-flex justify-content-center\">\r\n<\/div>\r\n<\/div>\r\n<\/div>"
